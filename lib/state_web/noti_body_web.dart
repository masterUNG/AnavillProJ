...
class NotiBoddyWeb extends StatefulWidget {
  const NotiBoddyWeb({super.key});

  @override
  State<NotiBoddyWeb> createState() => _NotiBoddyWebState();
}

class _NotiBoddyWebState extends State<NotiBoddyWeb> {
  ...
  Future<void> findMyOrder() async {
    ...
    String? docIdAssociate = await GetStorage().read('user');
