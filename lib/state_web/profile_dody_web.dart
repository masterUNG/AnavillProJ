...
class ProfileBodyWeb extends StatefulWidget {
  @override
  State<ProfileBodyWeb> createState() => _ProfileBodyWebState();
}

class _ProfileBodyWebState extends State<ProfileBodyWeb> {
  ...
  Future<void> findUser() async {
    docIdAssociate =  GetStorage().read('user');
    AppSvervice().findProfileUserLogin(docIdAssociate: docIdAssociate);
  }
